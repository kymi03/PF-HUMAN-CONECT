...
//   console.log( );
  ...
  <div class="  bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    >
        <img class="" src={ props.media.images[0] ? props.media.images[0].imageUrl : 'https://humanconet.org/wp-content/uploads/2022/09/Anchincaya-Resiste-HC-01-1024x1024.webp' } alt="" />
