...
const User = useSelector(state => state.userAuth)
 ...
 const handleChange = (e) => {
    ...
    const anotherArray = props.currentPAD.map((item) => {
      return {
        title: item.name,
  ...
  return (
    ...
    <div className="flex mt-4 space-x-5 sm:justify-center md:mt-0">
          ...
          <button href="https://twitter.com/Human_Conet" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
          ...
          <button href="https://www.youtube.com/channel/UCUSeWaaZ5-T3NIEIFBiccwA" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
