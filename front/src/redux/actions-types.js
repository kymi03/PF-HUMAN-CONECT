...
export const GET_COMMENT_BY_USERID = "GET_COMMENT_BY_USERID";

export const GET_COMMENT_BY_REFERENCE = "GET_COMMENT_BY_REFERENCE";

export const LOG_OUT_USER_AUTH = "LOG_OUT_USER_AUTH"

export const GET_CONTENT_BY_COMMENT_REFERENCE = "GET_CONTENT_BY_COMMENT_REFERENCE"